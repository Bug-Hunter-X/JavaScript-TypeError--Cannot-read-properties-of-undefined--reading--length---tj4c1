...
console.log(foo(10)); //Output: TypeError: Cannot read properties of 10 (reading 'length')
console.log(foo({})); //Output: TypeError: Cannot read properties of [object Object] (reading 'length')